...
class BasePage:
    # здесь у нас 2 переменных
    # driver, берем из фикстур,
    # Url вносим строкой свой
    ...
    # устанавливаем что бы страница открылась
    def open(self):
    ...
    # устанавливаеможидания после того как установили драйвер
